...
class Octagon: #Импортировали необход. бибилиотеки, создали класс октагон
    ...
    def picture(self): #отрисовываем графики наших фигур, вводим радиус впис. и опис. окруж-стей 
        ...
        plt.gca().add_patch(
            plt.Circle((0, 0), R, fill=False, color="red") #отрисовали опис. окруж, где R - ее радиус, заливка цвтом выключена, а цвет окруж. - красный
        )

        plt.gca().add_patch(
            plt.Circle((0, 0), r, fill=False, color="green") #то же самео, только впис. окруж, где r - радиус впис. окруж, цвет зеленый
        )
